...
y = np.loadtxt('trimap20k_vec2D.txt')
z = np.loadtxt('tsne20k_vec2D.txt')
m = np.loadtxt('largeVis20k_vec2D.txt')
t_trimap = trustworthiness(x, y, ks=range(10))
t_tsne = trustworthiness(x, z, ks=range(10))
t_largeVis = trustworthiness(x, m, ks=range(10))
